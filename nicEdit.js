...
var nicEditor = bkClass.extend({
	...
	panelInstance : function(e,o) {
		...
		//var panelElm = new bkElement('DIV').setStyle({width : (parseInt(e.getStyle('width')) || e.clientWidth)+'px'}).appendBefore(e); // Wordpress - Inline Editor plugin (0.6.13) - Removed to solve IE6/7 no panel problem.
